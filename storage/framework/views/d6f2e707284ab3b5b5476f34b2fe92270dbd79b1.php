...
<?php $__env->startSection('content'); ?>
	...
	<div class="row">
		...
		<div class="col-md-2">
			<a href="<?php echo e(route('posts.create')); ?>" class="btn btn-block btn-lg btn-primary btn-h1-spacing">Create New Post</a>
		</div>
				...
				<tbody>
					<?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<tr>
					        ...
					        <td><?php echo e(substr($post->body, 0, 100)); ?> <?php echo e(strlen($post->body) > 50 ? "..." : ""); ?> </td>
